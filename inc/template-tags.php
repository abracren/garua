...
if ( ! function_exists( 'garua_paging_nav' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 */
function garua_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		<h1 class="screen-reader-text"><?php _e( 'Posts navigation', 'garua' ); ?></h1>
		<div class="nav-links">
...
if ( ! function_exists( 'garua_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 */
function garua_post_nav() {
...
if ( ! function_exists( 'garua_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function garua_posted_on() {
...
if ( ! function_exists( 'garua_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function garua_entry_footer() {
	...
	if ( 'post' == get_post_type() ) {
		...
		if ( $tags_list ) {
			printf( '<span class="tags-links">' . __( 'Tagged %1$s', 'garua' ) . '</span>', $tags_list );
		}
	}
	...
	edit_post_link( __( 'Edit', 'garua' ), '<span class="edit-link">', '</span>' );
}
endif;
 ...
 * @return bool
 */
function garua_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'garua_categories' ) ) ) {
		...
		set_transient( 'garua_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so garua_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so garua_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in garua_categorized_blog.
 */
function garua_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'garua_categories' );
}
